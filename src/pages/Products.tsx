...
const Products = () => {
  ...
  const products = [
    ...
    },
    {
      ...
      price: 120,
      unit: "kg",
      image: "https://images.unsplash.com/photo-1560806887-1e4cd0b6cbd6?auto=format&fit=crop&w=400&h=400",
      rating: 4.8,
    ...
    },
    {
      ...
      price: 45,
      unit: "dozen",
      image: "https://images.unsplash.com/photo-1571771894821-ce9b6c11b08e?auto=format&fit=crop&w=400&h=400",
      rating: 4.6,
